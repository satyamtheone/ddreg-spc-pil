...
const DynamicButton = forwardRef<HTMLButtonElement, Props>(
  (
    ...
    const variantsClass = {
      ...
      submit:
        "spc-primary-bg text-white spc-primary-bg-hover ",
      outline:
    ...
    return (
      <button
        ...
        className={`${variantsClass[variant]} px-4 hover:shadow-md md:py-4 py-1 shadow-sm rounded-lg w-full cursor-pointer ${className}`}
        {...props}
      >
        <div
